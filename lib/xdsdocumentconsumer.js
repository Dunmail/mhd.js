...
function RegistryStoredQuery(err, options, query, cb){
  options.method = "POST";
  ...
  req.write("<query:ResponseOption returnComposedObjects='true' returnType='" + query.returnType + "' />");
  ...
  req.write("<rim:Value>'" + query.params.XDSDocumentEntryPatientId + "'</rim:Value>");
  req.write("</rim:ValueList>");
  req.write("</rim:Slot>");
  req.write("<rim:Slot name='$XDSDocumentEntryStatus'>");
  req.write("<rim:ValueList>");
  req.write("<rim:Value>" + query.params.XDSDocumentEntryStatus + "</rim:Value>");
  req.write("</rim:ValueList>");
  req.write("</rim:Slot>");
